...
def main():
    ...
    plt.savefig(f"src/ehrenfestMeanFieldPuyo/plots/finalDistribution/growFromSelected_N{N_colors}_K{K_selections}.png", dpi=300)
    print(f"Distribution saved to src/ehrenfestMeanFieldPuyo/plots/finalDistribution/growFromSelected_N{N_colors}_K{K_selections}.png")
