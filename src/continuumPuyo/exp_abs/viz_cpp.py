...
def main():
    ...
    param_str = f"L{L}_T{T}_dt{dt}_a{a}_c{c_val}_lamexp{lambda_exp}_lam{lambda_abs}"
    out_dir = f"src/continuumPuyo/exp_abs/outputs/avalanchePDE_cpp/{param_str}"
    ...
    plots_dir = f"src/continuumPuyo/exp_abs/plots/cpp_L{L}_T{T}_dt{dt}_a{a}_c{c_val}_lamexp{lambda_exp}_lam{lambda_abs}"
